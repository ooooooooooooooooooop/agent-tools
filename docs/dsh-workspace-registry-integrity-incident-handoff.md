...
- An orphaned workspace record `c1e48f21-7910-482a-9f5b-3ee026949787` (`REDACTED`, path `C:\Desktop\REDACTED\REDACTED`, 3 sessions, created `2026-09-03T04:40:58Z`, updated `04:41:50Z`) existed in `tables.workspaces`.
